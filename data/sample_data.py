        ...
        st.session_state.estimations = [
            {
                ...
                'customer_name': 'TechCorp Industries',
                'product': 'Smart Router X200',
                'test_types': ['EMC Testing', 'RF Testing'],
                'total_cost': 85000.0,
                'status': 'sent',
            ...
            },
            {
                ...
                'customer_name': 'ElectroSystems Ltd',
                'product': 'RF Compliance Module',
                'test_types': ['RF Testing', 'Safety Testing'],
                'total_cost': 95000.0,
                'status': 'approved',
            ...
            },
            {
                ...
                'customer_name': 'Digital Solutions Inc',
                'product': 'IoT Sensor Hub',
                'test_types': ['Safety Testing', 'Environmental Testing'],
                'total_cost': 72000.0,
                'status': 'draft',
                'created_at': '2024-01-23',
                'valid_until': '2024-02-22',
                'notes': 'Awaiting customer confirmation on quantity',
            },
        ]
